...
public:
    ...
    public:
        ...
        bool trovato_cds_anno(const vector<string> &id_cds, const string &anno, int inserisco_nel_giorno);

        bool prof_disponibili(const vector<string> &id_professori, int inserisco_nel_giorno);
